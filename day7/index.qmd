...
<https://joelnitta.github.io/joho-shori/day7/>

## クイズ

## 連絡事項

- 倫理教育e-learningの締め切りは **11月20日（木）** です。
  - **早めの提出を心がけてください。**
...
ggplot(data, aes(x = x, y = y)) +
  ...
  # Slope annotation
  annotate("segment",
    x = 2.5, xend = 3.5, y = a * 2.5 + b, yend = a * 3.5 + b,
...
::: {.column width="50%"}
![](../images/penguin-plot-single-model.jpg)
:::
